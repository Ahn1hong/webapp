...
import foot from './components/views/foot.vue';
...
let home_data = {
    desktop: {
        ...
        description:
            'Standalone or cloud-based, we can provide solution for our clients. We develop application which is not only cross-platform also cost effective. We have expertise in technologies like JavaFx, Dot Net etc.'
    },
    web_back: {
        title: 'Database Solution That is Future Proof & Scalable.',
        description:
            'Most relatable, robust and scalable backend frameworks are our first choice when planning solutions. We have years experience in proven technologies like Django, Laravel and Spring Boot.'
    },
    mobile: {
        title: 'Want Dedicated and Customized Android & iOS App?',
        description:
            'We provide services to build apps according to your requirements. We build for iOS and Android both for the same cost. Trust us to solve your problems.'
    }
};
...
let development_data = {
    ...
    features: {
        seo: {
            ...
            description:
                "We offer SEO services to improve website visibility  & ranking. Our team uses latest techniques to drive organic traffic. Services include keyword research, on-page optimization, link building, content optimization & local SEO. Goal is to deliver measurable results & increase clients' online presence."
        },
        repair: {
            title: 'Maintenance / Upgrade',
            description:
                'We specialize in maintaining, fixing, upgrading, and scaling software for businesses. Our team of experts can troubleshoot and resolve software issues quickly. We offer maintenance, repair, upgrading and scaling services to ensure software is always running smoothly and up to date.'
        },
        web: {
            title: 'Web Development',
            description:
                'We offer web development using Vue3, React, Django, PHP, and Laravel to create efficient websites. Our proficiency in multiple frameworks enables us to fulfill various client needs with tailored solutions.'
        },
        pbx: {
            title: 'IP Telephony',
            description:
                'We provide PBX (Private Branch Exchange) setup and configuration services for businesses of all sizes. Our  experts has  knowledge and experience in configuring and setting up PBX systems to meet the specific needs of our clients. We help businesses improve their communication efficiency and reduce costs.'
        },
        desktop: {
            title: 'Desktop Application',
            description:
                'We specialize in developing robust desktop software using a variety of technologies such as JavaFX, Dot Net, Qt, and more. Whether your business is in finance, healthcare, or logistics, we are well-suited to provide you with the software solutions you need to run on desktop devices.'
        },
        phone: {
            title: 'Mobile App (iOS / Android)',
            description:
                'We specializes in the development of high-performance and efficient mobile applications for both Android and iOS platforms. Utilizing web architecture and scalable technologies, our team of highly skilled developers are able to design user-friendly applications that can accommodate a substantial user base. '
        }
    }
};
...
let pricing_data = {
    ...
    telephony: [
        ...
        },
        {
            ...
            features: [
                'On-premises',
                'Advanced features, such as call routing and voicemail',
